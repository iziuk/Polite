...
- package-lock.json
- apps/web/package.json
- apps/web/src/\*_/_.test.tsx
- apps/web/src/\*_/_.test.ts
- apps/web/src/widgets/phrase-browser/ui/phrase-browser.tsx
- apps/mobile/package.json
...
- apps/mobile/.eas/workflows/\*.yml
- apps/mobile/.maestro/\*.yml
- apps/mobile/src/\*_/_.test.tsx
- apps/mobile/src/\*_/_.test.ts
- apps/mobile/src/shared/ui/button/button.tsx
- apps/mobile/src/widgets/phrase-browser/\*_/_.tsx
- apps/mobile/src/widgets/phrase-browser/model/filter-phrases.ts
- packages/shared/src/lib/filter-phrases.ts
- packages/shared/src/lib/\*.test.ts
- .ai/ai-sdlc/\*_/_.md
- .ai/project-knowledge/README.md
- .ai/tools/project-knowledge/search.mjs

Updated map files:

- INDEX.md -> Yarn 4, 100% unit/component coverage, Playwright, Maestro/EAS, shared filtering
- modules.yaml -> web-config, mobile-config, shared-package, shared-browser-lib, phrase-browser widgets, AI SDLC, project-knowledge retrieval
- decisions.md -> ADR-009 package-manager and test automation decision
- data-flow.md -> Yarn project-knowledge command reference
- update-log.md -> this entry

Notes:

- Migrated npm lockfile to Yarn 4 with `nodeLinker: node-modules`.
