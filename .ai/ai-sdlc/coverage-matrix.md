...
| AI SDLC            | AI development policy, role playbooks, agent instructions, workflow, risk register, eval criteria, human approval gates | `ai-development-policy.md`, `workflow.md`, `roles.md`, `quality-gates.md`, `security-risk.md`, `templates/risk-register-entry.md`                                                                                                                                      | Covered  |
| Knowledge / RAG    | Source priority, context retrieval, RAG strategy, freshness, citations, indexing policy, evals, prompt-injection rules  | `rag-strategy.md`, `adr.md`, `adr/`, `templates/rag-strategy.md`, `templates/ai-feature-spec.md`, `templates/evaluation-plan.md`, `templates/threat-model.md`, `templates/privacy-pii-policy.md`, `templates/risk-register-entry.md`                                   | Covered  |
...
| Role matrix        | AI Product Owner, BA, Architect, Frontend, Backend, QA Manual, QA Automation, DevOps, Security, Human Approver          | `roles.md`, `responsibility-matrix.md`                                                                                                                                                                                                                                 | Covered  |
