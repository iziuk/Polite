...
| Architecture       | System overview, C4 diagrams, ADR, constraints, integrations, data model, NFR                                           | `architecture.md`, `templates/architecture-overview.md`, `templates/c4-diagram.md`, `templates/adr.md`, `templates/integration-contract.md`, `templates/data-model.md`, `templates/non-functional-requirements.md`                                                     | Covered  |
