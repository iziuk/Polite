...
| AI SDLC            | AI development policy, role playbooks, agent instructions, workflow, PR lifecycle, risk register, eval criteria, human approval gates | `ai-development-policy.md`, `workflow.md`, `roles.md`, `quality-gates.md`, `security-risk.md`, `templates/risk-register-entry.md`                                                                                                                                                                                | Covered  |
...
| PR lifecycle       | PR owner role, PR creation workflow stage, PR reviewer role, PR review gate, PR merge gate, RACI ownership, PR checklist              | `roles.md`, `workflow.md`, `quality-gates.md`, `responsibility-matrix.md`, `governance.md`, `templates/pr-checklist.md`                                                                                                                                                                                          | Covered  |
...
| Role matrix        | AI Product Owner, BA, Architect, Frontend, Backend, PR Owner, PR Reviewer, QA Manual, QA Automation, DevOps, Security, Human Approver | `roles.md`, `responsibility-matrix.md`                                                                                                                                                                                                                                                                           | Covered  |
